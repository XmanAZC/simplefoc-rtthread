...
void  BLDCDriver6PWM::enable(){
    ...
    if ( _isset(enable_pin) ) rt_pin_write(enable_pin, enable_active_high);
...
int BLDCDriver6PWM::init() {
  ...
  // PWM pins
  rt_pin_mode(pwmA_h, PIN_MODE_OUTPUT);
  rt_pin_mode(pwmB_h, PIN_MODE_OUTPUT);
  rt_pin_mode(pwmC_h, PIN_MODE_OUTPUT);
  rt_pin_mode(pwmA_l, PIN_MODE_OUTPUT);
  rt_pin_mode(pwmB_l, PIN_MODE_OUTPUT);
  rt_pin_mode(pwmC_l, PIN_MODE_OUTPUT);
  if(_isset(enable_pin)) rt_pin_mode(enable_pin, PIN_MODE_OUTPUT);
