...
class HallSensor: public Sensor{
 public:
    ...
    */
     ...
     * 
     */
    void enableInterrupts(void (*doA)(void *args) = nullptr, void(*doB)(void *args) = nullptr, void(*doC)(void *args) = nullptr);

    //  HallSensor interrupt callback functions
    /** A channel callback function */
    void handleA(void *args=nullptr);
    /** B channel callback function */
    void handleB(void *args=nullptr);
    /** C channel callback function */
    void handleC(void *args=nullptr);
